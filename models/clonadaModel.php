...
class ClonadaModel extends Model{
    ...
    public function insertaref($datos){
        ...
        expediente, nombre,nacio,sexo,telefono,areamedica,servicio1,situacion,fconsulta,
        motivo,umreceptora,
        ciudad,estatus) VALUES('',:idpaciente,:expediente, :nombre, :nacio, :sexo,:telefono, 
        :areamedica,:servicio1,:situacion,:fconsulta,:motivo, :umreceptora, :ciudad,:estatus)");
        try{
            $query->execute([
